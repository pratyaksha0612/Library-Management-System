...
let books = [
    { bookId: 1, title: "Harry Potter and the Philosopher's Stone", author: "J.K. Rowling", genre: "Fantasy", isbn: "978-0747532699", publishedDate: "1997-06-26", price: 499, isAvailable: true, coverImage: "https://m.media-amazon.com/images/I/81q77Q39nEL._AC_UF1000,1000_QL80_.jpg", description: "The first novel in the Harry Potter series." },
    { bookId: 2, title: "Harry Potter and the Chamber of Secrets", author: "J.K. Rowling", genre: "Fantasy", isbn: "978-0747538493", publishedDate: "1998-07-02", price: 499, isAvailable: true, coverImage: "https://m.media-amazon.com/images/I/81OthjkJBuL._AC_UF1000,1000_QL80_.jpg", description: "The second novel in the Harry Potter series." },
    { bookId: 3, title: "The Hobbit", author: "J.R.R. Tolkien", genre: "Fantasy", isbn: "978-0261102217", publishedDate: "1937-09-21", price: 399, isAvailable: true, coverImage: "https://m.media-amazon.com/images/I/712cDO7d73L._AC_UF1000,1000_QL80_.jpg", description: "A fantasy novel and children's book." },
    { bookId: 4, title: "The Alchemist", author: "Paulo Coelho", genre: "Fiction", isbn: "978-0062315007", publishedDate: "1988-04-15", price: 299, isAvailable: true, coverImage: "https://m.media-amazon.com/images/I/71aFt4+OTOL._AC_UF1000,1000_QL80_.jpg", description: "A novel about a young Andalusian shepherd." },
    { bookId: 5, title: "1984", author: "George Orwell", genre: "Science Fiction", isbn: "978-0451524935", publishedDate: "1949-06-08", price: 350, isAvailable: true, coverImage: "https://m.media-amazon.com/images/I/71kxa1-0mfL._AC_UF1000,1000_QL80_.jpg", description: "A dystopian social science fiction novel." },
    { bookId: 6, title: "The Kite Runner", author: "Khaled Hosseini", genre: "Historical Fiction", isbn: "978-1594631931", publishedDate: "2003-05-29", price: 450, isAvailable: true, coverImage: "https://m.media-amazon.com/images/I/81bEEzEb3uL._AC_UF1000,1000_QL80_.jpg", description: "A novel about the unlikely friendship between a wealthy boy and the son of his father's servant." },
    { bookId: 7, title: "Wings of Fire", author: "A.P.J. Abdul Kalam", genre: "Autobiography", isbn: "978-8173711466", publishedDate: "1999-01-01", price: 399, isAvailable: true, coverImage: "https://m.media-amazon.com/images/I/71KKZlVjbwL._AC_UF1000,1000_QL80_.jpg", description: "An autobiography of A.P.J. Abdul Kalam." },
    { bookId: 8, title: "Panchatantra", author: "Vishnu Sharma", genre: "Fable", isbn: "978-8171670642", publishedDate: "1990-01-01", price: 150, isAvailable: true, coverImage: "https://m.media-amazon.com/images/I/81TjRLH46uL._AC_UF1000,1000_QL80_.jpg", description: "An ancient Indian collection of interrelated animal fables." },
    { bookId: 9, title: "Sapiens", author: "Yuval Noah Harari", genre: "Non-fiction", isbn: "978-0062316097", publishedDate: "2011-01-01", price: 599, isAvailable: true, coverImage: "https://m.media-amazon.com/images/I/713jIoMO3UL._AC_UF1000,1000_QL80_.jpg", description: "A brief history of humankind." },
    { bookId: 10, title: "Atomic Habits", author: "James Clear", genre: "Self-help", isbn: "978-0735211292", publishedDate: "2018-10-16", price: 499, isAvailable: true, coverImage: "https://m.media-amazon.com/images/I/81bGKUa1e0L._AC_UF1000,1000_QL80_.jpg", description: "An easy & proven way to build good habits & break bad ones." },
    { bookId: 11, title: "Ikigai", author: "Hector Garcia", genre: "Philosophy", isbn: "978-0143130727", publishedDate: "2017-08-29", price: 399, isAvailable: true, coverImage: "https://m.media-amazon.com/images/I/81l3rZK4lnL._AC_UF1000,1000_QL80_.jpg", description: "The Japanese secret to a long and happy life." },
    { bookId: 12, title: "The Psychology of Money", author: "Morgan Housel", genre: "Finance", isbn: "978-0857197689", publishedDate: "2020-09-08", price: 399, isAvailable: true, coverImage: "https://m.media-amazon.com/images/I/71TRUbziHeL._AC_UF1000,1000_QL80_.jpg", description: "Timeless lessons on wealth, greed, and happiness." },
    { bookId: 13, title: "Rich Dad Poor Dad", author: "Robert T. Kiyosaki", genre: "Finance", isbn: "978-1612680194", publishedDate: "1997-04-01", price: 350, isAvailable: true, coverImage: "https://m.media-amazon.com/images/I/81bsw6fnUiL._AC_UF1000,1000_QL80_.jpg", description: "What the rich teach their kids about money." },
    { bookId: 14, title: "A Brief History of Time", author: "Stephen Hawking", genre: "Science", isbn: "978-0553380163", publishedDate: "1988-03-01", price: 450, isAvailable: true, coverImage: "https://m.media-amazon.com/images/I/81fH+l1bCXL._AC_UF1000,1000_QL80_.jpg", description: "From the Big Bang to Black Holes." }
];

// Seed Data - Students (Indian Profiles & User Email)
let students = [
    { studentId: 1, studentName: "Amar Singh", email: "amar.singh@student.in", phone: "+91 98765 00001", membershipDate: "2023-08-15", borrowCount: 12 },
    { studentId: 2, studentName: "Kiran Sharma", email: "kiran.s@student.in", phone: "+91 98765 00002", membershipDate: "2024-01-10", borrowCount: 5 },
    { studentId: 3, studentName: "Shriya Verma", email: "shriya.v@student.in", phone: "+91 98765 00003", membershipDate: "2023-11-20", borrowCount: 8 },
    { studentId: 4, studentName: "Anu Gupta", email: "anu.g@student.in", phone: "+91 98765 00004", membershipDate: "2024-03-05", borrowCount: 3 },
    ...
    { studentId: 8, studentName: "Vijay Singh", email: "vijay.s@student.in", phone: "+91 98765 00008", membershipDate: "2023-01-22", borrowCount: 15 },
    { studentId: 9, studentName: "Vibha Reddy", email: "vibha.r@student.in", phone: "+91 98765 00009", membershipDate: "2023-12-05", borrowCount: 6 },
    { studentId: 10, studentName: "Jay Shah", email: "jay.s@student.in", phone: "+91 98765 00010", membershipDate: "2024-02-14", borrowCount: 9 },
    { studentId: 11, studentName: "Rishi Desai", email: "rishi.d@student.in", phone: "+91 98765 00011", membershipDate: "2023-10-30", borrowCount: 11 }
];
