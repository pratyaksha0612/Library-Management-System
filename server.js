...
let newspapers = [
    ...
    { newspaperId: 10, title: 'The Hindu Business Line', publisher: 'Kasturi & Sons', language: 'English', category: 'Business', dailyPrice: 8, subscriptionType: 'Weekly', publishDate: '2026-07-28', isAvailable: true },
    { newspaperId: 11, title: 'Mint', publisher: 'HT Media', language: 'English', category: 'Business', dailyPrice: 9, subscriptionType: 'Daily', publishDate: '2026-07-28', isAvailable: true },
    { newspaperId: 12, title: 'Deccan Chronicle', publisher: 'Deccan Chronicle Holdings', language: 'English', category: 'National Daily', dailyPrice: 5, subscriptionType: 'Monthly', publishDate: '2026-07-28', isAvailable: true },
    { newspaperId: 13, title: 'The Statesman', publisher: 'The Statesman Ltd', language: 'English', category: 'National Daily', dailyPrice: 6, subscriptionType: 'Daily', publishDate: '2026-07-28', isAvailable: true },
    { newspaperId: 14, title: 'Dainik Bhaskar', publisher: 'Dainik Bhaskar Group', language: 'Hindi', category: 'National Daily', dailyPrice: 4, subscriptionType: 'Monthly', publishDate: '2026-07-28', isAvailable: true },
    { newspaperId: 15, title: 'Amar Ujala', publisher: 'Amar Ujala Ltd', language: 'Hindi', category: 'National Daily', dailyPrice: 4, subscriptionType: 'Daily', publishDate: '2026-07-28', isAvailable: true },
];
...
let magazines = [
    ...
    { magazineId: 8, title: 'Forbes India', publisher: 'Network18', issueNumber: 'August 2026', genre: 'Business', price: 200, frequency: 'Yearly', isAvailable: true, publishDate: '2026-07-01' },
    { magazineId: 9, title: 'Vogue India', publisher: 'Condé Nast', issueNumber: 'August 2026', genre: 'Fashion', price: 150, frequency: 'Monthly', isAvailable: true, publishDate: '2026-07-01' },
    { magazineId: 10, title: 'Digit', publisher: '9.9 Group', issueNumber: 'August 2026', genre: 'Technology', price: 125, frequency: 'Yearly', isAvailable: true, publishDate: '2026-07-01' },
    { magazineId: 11, title: 'Filmfare', publisher: 'Worldwide Media', issueNumber: 'August 2026', genre: 'Entertainment', price: 100, frequency: 'Monthly', isAvailable: true, publishDate: '2026-07-01' },
    { magazineId: 12, title: 'Outlook', publisher: 'Rajan Raheja Group', issueNumber: 'August 2026', genre: 'News', price: 90, frequency: 'Yearly', isAvailable: true, publishDate: '2026-07-01' },
    { magazineId: 13, title: 'Frontline', publisher: 'The Hindu Group', issueNumber: 'August 2026', genre: 'Current Affairs', price: 85, frequency: 'Monthly', isAvailable: true, publishDate: '2026-07-01' },
    { magazineId: 14, title: 'Competition Success Review', publisher: 'CSR', issueNumber: 'August 2026', genre: 'Education', price: 75, frequency: 'Yearly', isAvailable: true, publishDate: '2026-07-01' },
    { magazineId: 15, title: 'Sportstar', publisher: 'The Hindu Group', issueNumber: 'August 2026', genre: 'Sports', price: 80, frequency: 'Monthly', isAvailable: true, publishDate: '2026-07-01' },
];
